...
<div class="wrapper">
    ...
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-dark fixed-top" style="background-color: #6206a8">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('About')}}" class="nav-link">ჩვენს შესახებ</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('Contact')}}" class="nav-link">კონტაქტი</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #6206a8">
        <!-- Brand Logo -->
    ...
    <footer class="main-footer text-center">
        <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Davitius</a>.</strong>
        All rights reserved.
